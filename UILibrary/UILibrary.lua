		...
		return function(aa, ab)
			return {
				Dark = {
                    ...
                    WindowTopbarAuthor = Color3.fromHex("#D2D2D2"),
                    WindowTopbarButtonIcon = Color3.fromHex("#FF0000"),
                    WindowSearchBarBackground = Color3.fromHex("#141414"),
                    TabBackground = Color3.fromHex("#FF0000"),
                    TabBackgroundHover = Color3.fromHex("#FF0000"),
                    TabBackgroundHoverTransparency = 0.90,
                    TabBackgroundActive = Color3.fromHex("#FF0000"),
                    ...
                    DialogBackground = Color3.fromHex("#1E1E1E"),
                    DialogBackgroundTransparency = "BackgroundTransparency",
                    ...
                    CheckboxBorder = Color3.fromHex("#FF0000"),
                    CheckboxBorderTransparency = 0.4,
                    SliderIcon = Color3.fromHex("#FF0000"),
                    Slider = Color3.fromHex("#FF0000"),
                    SliderThumb = Color3.fromHex("#FFFFFF"),
                    SliderIconFrom = Color3.fromHex("#FF0000"),
                    SliderIconTo = Color3.fromHex("#FF0000"),
                    Tooltip = Color3.fromHex("#141414"),
                    TooltipText = Color3.fromHex("#FFFFFF"),
                    TooltipSecondary = Color3.fromHex("#FF0000"),
                    TooltipSecondaryText = Color3.fromHex("#FFFFFF"),
                    TabSectionIcon = Color3.fromHex("#FF0000"),
                    SectionIcon = Color3.fromHex("#FF0000"),
                    SectionExpandIcon = Color3.fromHex("#FFFFFF"),
                    SectionExpandIconTransparency = 0.3,
                    SectionBox = Color3.fromHex("#FF0000"),
                    SectionBoxTransparency = 0.97,
                    SectionBoxBorder = Color3.fromHex("#FF0000"),
                    SectionBoxBorderTransparency = 0.45,
                    SectionBoxBackground = Color3.fromHex("#FF0000"),
                    SectionBoxBackgroundTransparency = 0.97,
                    SearchBarBorder = Color3.fromHex("#141414"),
                    SearchBarBorderTransparency = 0.55,
                    Notification = Color3.fromHex("#000000"),
                    NotificationTitle = Color3.fromHex("#FFFFFF"),
                    NotificationTitleTransparency = 0,
                    NotificationContent = Color3.fromHex("#E1E1E1"),
                    NotificationContentTransparency = 0.2,
                    NotificationDuration = Color3.fromHex("#FF0000"),
                    NotificationDurationTransparency = 0.1,
                    NotificationBorder = Color3.fromHex("#FF0000"),
                    NotificationBorderTransparency = 0.45,
                    DropdownTabBorder = Color3.fromHex("#FF0000"),
                    LabelBackground = Color3.fromHex("#FF0000"),
